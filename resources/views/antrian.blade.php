    ...
    <body>
      ...
      <main>
        <div class="px-5 py-5 text-center">
          ...
          <div class="mb-3 bg-body-tertiary rounded-3 d-flex align-items-center justify-content-center" style="height: 400px;">
            <div class="container-fluid">
              <p class="" style="font-size:30pt;">
                BUAT SLIDE SHOW VIDEO
              </p>
              {{-- <p class="" style="font-size:30pt;">
                Antrian Sekarang
              </p>
          ...
          <div class="row align-items-md-stretch">
            ...
            @foreach($pelayananLoket as $pelayanan)
              <div class="{{$classColMd}}">
                <a href="#" class="text-decoration-none clickAntrian" data-antrian="{{$pelayanan}}" data-action="{{route('antrian.get-antrian')}}" data-wilayah="{{\Auth::user()->wilayah}}">
            ...
            <div class="modal-content">
              <div class="modal-body"> 
                <div class="modal-toggle-wrapper">  
                  ...
                  <h4 class="text-center" id="headerModal" style="font-size: 35pt;"></h4>
                  <p class="text-center">
                    <div id="bodyModal" class="text-center" style="font-size: 20pt;"></div>
                    <br>
                  ...
                  <button class="btn btn-danger d-flex m-auto" type="button" id="btnModalAntrian">Tutup</button>
                </div>
              </div>
            </div>
          </div>
            ...
            $.ajax({
              ...
              success: async function (data) {
                ...
                if (data.success == true) {
                  ...
                  await $('#bodyModal').html('Nomor Antrian Anda adalah <br><strong style="font-size: 50pt;">' + data.data.number + '</strong>');
