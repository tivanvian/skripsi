        ...
        <div class="card card-body mb-4">
            <article class="icontext">
                ...
                <div class="text">
                    ...
                    <span>__</span>
                    <span class="text-sm"> In __ Categories </span>
                </div>
            </article>
        </div>
    </div>
                        ...
                        <div class="new-member-list">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('backend/assets/imgs/people/avatar-4.png') }}" alt="" class="avatar" />
                                    <div>
                                        <h6>Patric Adams</h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('backend/assets/imgs/people/avatar-2.png') }}" alt="" class="avatar" />
                                    <div>
                                        <h6>Dilan Specter</h6>
                                        <p class="text-muted font-xs">Sanfrancisco</p>
                                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <img src="{{asset('backend/assets/imgs/people/avatar-3.png') }}" alt="" class="avatar" />
                                    <div>
                                        <h6>Tomas Baker</h6>
                                        <p class="text-muted font-xs">Sanfrancisco</p>
                                    </div>
